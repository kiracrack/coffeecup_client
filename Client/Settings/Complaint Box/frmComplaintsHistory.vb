...
Imports System
Public Class frmComplaintsHistory
    ...
    Private Sub frmComplaintsHistory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Icon = ico
        ShowFilters()
    End Sub
    Public Sub ShowFilters()
        MyDataGridView.DataSource = Nothing : dst = New DataSet
        msda = New MySqlDataAdapter("Select Remarks, postedby as 'Posted By',  dateposted as 'Date Posted'  from tblcomplaintboxlogs where complaintcode='" & code.Text & "'" _
    ...
    Private Sub cmdset_Click(sender As Object, e As EventArgs) Handles cmdset.Click
        ...
        If MessageBox.Show("Are you sure you want to post? ", GlobalOrganizationName, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = vbYes Then
            com.CommandText = "insert into tblcomplaintboxlogs set complaintcode='" & code.Text & "', remarks='" & rchar(txtContent.Text) & "', dateposted=current_timestamp, postedby='" & globalfullname & "'" : com.ExecuteNonQuery()
