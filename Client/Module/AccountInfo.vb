...
Module AccountInfo
    ...
    Public globalAuthReceivingReport As Boolean
    ...
    Public globalAuthRoomAppInquiries As Boolean
    ...
    Public compLowConnectionTagging As Boolean
    ...
    Public GLobalenablereceivingreport As Boolean
    Public GLobalenableclientupdatecustomerinfo As Boolean
    Public Globalenablshowallproductsuponpr As Boolean
    Public Globalenablebybranchvoucher As Boolean
    Public GlobalEnableAccountingVoucher As Boolean
    Public GLobalEnableCentralStockReceiving As Boolean
    ...
    Public Function LoadAccountDetails(ByVal userid As String)
        ...
        While rst.Read
            ...
            globalAuthReceivingReport = rst("receivingreport")
            ...
            globalAuthRoomAppInquiries = rst("roomappinquiries")
        ...
        While rst.Read
            ...
            compLowConnectionTagging = rst("lowconnectiontagging")
        End While
        rst.Close()
        ...
        While rst.Read
            Dim picbox As New PictureBox
            ConvertDatabaseImage("logo", picbox)
            If System.IO.File.Exists(Application.StartupPath.ToString & "\Logo\" & rst("companycode").ToString & ".png") = True Then
                System.IO.File.Delete(Application.StartupPath.ToString & "\Logo\" & rst("companycode").ToString & ".png")
            End If
            If Not picbox.Image Is Nothing Then
                picbox.Image.Save(Application.StartupPath.ToString & "\Logo\" & rst("companycode").ToString & ".png", System.Drawing.Imaging.ImageFormat.Png)
            End If
        End While
        rst.Close()
        ...
        While rst.Read
            ...
            GLobalenablereceivingreport = rst("enablereceivingreport")
            GLobalenableclientupdatecustomerinfo = rst("enableclientupdatecustomerinfo")
            Globalenablshowallproductsuponpr = rst("enablshowallproductsuponpr")
            Globalenablebybranchvoucher = rst("enablebybranchvoucher")
            GlobalEnableAccountingVoucher = rst("enableaccountingvoucher")
            GLobalEnableCentralStockReceiving = rst("enablecentralstockreceiving")
        End While
        rst.Close()
        ...
        If EnableModuleSales = True Then
            If countqry("tblsalessummary", "userid='" & globaluserid & "' and openfortrn=1") = 0 Then
                ...
                globalSalesTrnCOde = ""
            Else
                If countqry("tblsalessummary", "userid='" & globaluserid & "' and openfortrn=1") > 1 Then
                    frmPOSselectPOSTransaction.ShowDialog()
                Else
    ...
    Public Sub CloseSystemDeclaration()
        ...
        globalAuthRoomAppInquiries = False
        ...
        GLobalenableclientupdatecustomerinfo = False
        GLobalEnableCentralStockReceiving = False
