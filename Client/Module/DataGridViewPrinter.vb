...
Class DataGridViewPrinter
    ...
    Public thePageHeader As String
    Public thePageTitle As String
    Public thePageDescription As String
    ...
    Public Sub New(ByVal aDataGridView As DataGridView, ByVal aPrintDocument As PrintDocument, ByVal CenterOnPage As Boolean, ByVal WithTitle As Boolean, _
                   ByVal PageHeader As String, _
                   ByVal PageTitle As String, _
                   ByVal PageDescription As String, _
                   ByVal WithPaging As Boolean)
        ...
        thePageDescription = PageDescription
    ...
    Public Sub DrawHeader(ByVal g As Graphics)
        ...
        If IsWithTitle Then
            ...
            Dim fontHeader As Font = New Font("Arial", 12, FontStyle.Regular, GraphicsUnit.Point)
            Dim fontTitle As Font = New Font("Arial", 11, FontStyle.Regular, GraphicsUnit.Point)
            Dim fontDescription As Font = New Font("Arial", 8.25, FontStyle.Regular, GraphicsUnit.Point)
            'draw Header
            Dim HeaderRectangle As New RectangleF(CSng(LeftMargin), CurrentY, CSng(PageWidth) - CSng(RightMargin) - CSng(LeftMargin), g.MeasureString(thePageHeader, fontHeader).Height + 10)
            Dim TitleRectangle As New RectangleF(CSng(LeftMargin), CurrentY + HeaderRectangle.Height, CSng(PageWidth) - CSng(RightMargin) - CSng(LeftMargin), g.MeasureString(thePageTitle, fontTitle).Height)
            Dim DescRectangle As New RectangleF(CSng(LeftMargin), CurrentY + HeaderRectangle.Height + TitleRectangle.Height, CSng(PageWidth) - CSng(RightMargin) - CSng(LeftMargin), g.MeasureString(thePageDescription, fontDescription).Height + 10)
            g.DrawString(thePageHeader, fontHeader, New SolidBrush(Color.Black), HeaderRectangle, TitleFormat)
            g.DrawString(thePageTitle, fontTitle, New SolidBrush(Color.Black), TitleRectangle, TitleFormat)
            g.DrawString(thePageDescription, fontDescription, New SolidBrush(Color.Black), DescRectangle, TitleFormat)
            CurrentY += g.MeasureString(thePageHeader, fontHeader).Height + g.MeasureString(thePageTitle, fontHeader).Height + g.MeasureString(thePageDescription, fontHeader).Height + 10
            ' CurrentY += g.MeasureString(thePageHeader, fontHeader).Height
        End If
