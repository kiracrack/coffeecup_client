Public Class ColorSchemes
    ...
    Public Shared SelectedBorder = New SolidBrush(Color.FromArgb(194, 138, 48))
    ...
    Public Shared UnSelectedBorder = New SolidBrush(Color.FromArgb(125, 162, 206))

    Public Shared DisabledBorder = New SolidBrush(Color.White)
