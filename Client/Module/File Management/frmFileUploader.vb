            ...
            If MyDataGridView.RowCount > 0 Then
                For i = 0 To MyDataGridView.RowCount - 1
                    If trntype.Text = "HotelFolio" Then
                        LogAuditTrail("HOTEL", If(HotelOperationMode = True, "Front Desk", "Reservation"), trncode.Text, "Added attachement " & rchar(Path.GetFileName(MyDataGridView.Rows(i).Cells("Location").Value())))
                    End If
