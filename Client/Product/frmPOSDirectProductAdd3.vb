...
Public Class frmPOSDirectProductAdd3
...
#End Region
    ...
    Private Sub cmdset_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        productid.Text = getproid() : txtBarcode.Text = "" : txtProductName.Text = "" : txtPartNumber.Text = "" : txtPurchasePrice.Value = 0 : txtSellingCost.Value = 0 : txtBeginningQuantity.Value = 0 : txtProductName.Focus()
