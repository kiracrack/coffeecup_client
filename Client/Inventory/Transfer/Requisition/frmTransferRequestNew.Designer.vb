...
Partial Class frmTransferRequestNew
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmTransferRequestNew))
        ...
        Me.lbldescription.Text = "You can use this form to create stock transfer request from other offices"
        '
        'Label6
        '
    ...
    "_____________________"
        ...
        Me.ToolStripButton1.Text = "Send Request"
        '
        'MyDataGridView
        '
